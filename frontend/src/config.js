...
const featuredItems = [
  {
    id: 1,
    name: "শুকরানা স্পেশাল বিরিয়ানি",
    description:
      "খাসির নরম মাংস আর বাসমতি চালের পারফেক্ট ব্লেন্ড যা মুখে দিলেই মিলিয়ে যাবে।",
    price: "৪৫০",
    image:
  ...
  },
  {
    ...
    description:
      "ডিম আর কিমার পুড় ঠাসা মচমচে পরোটা, পরিবেশন করা হয় আলুর দমের সাথে।",
    price: "১৮০",
    image:
...
const blogPosts = [
  {
    ...
    excerpt:
      "চিজের ভেতরে থাকা ক্যাসোমরফিন নামক একটি যৌগ আমাদের মস্তিষ্কে ডোপামিন রিলিজ করে। এই কারণেই আমরা নিজেদের সামলাতে পারি না...",
    image:
  ...
  },
  {
    ...
    excerpt:
      "সারাদিন কাজের চাপে যখন মাথা ঘোরে, তখন এক প্লেট ধোঁয়া ওঠা পাস্তা হতে পারে আপনার সেরা বন্ধু। জানুন বিস্তারিত...",
    image:
  ...
  },
  {
    ...
    excerpt:
      "শুকরানা রেস্টুরেন্ট মুঘলাই ঐতিহ্যকে আধুনিকতার সাথে মিশিয়েছে। এখানকার প্রতিটি পরিবারে আছে নিজস্ব রান্নার ঐতিহ্য...",
    image:
...
export const clientConfig = {
  brand: {
    ...
    intro: "শুকরানা রেস্টুরেন্টে আপনার প্রতিটি কামড় হোক তৃপ্তির উৎস।",
  ...
  contact: {
    ...
    addressLines: ["৭৯/৮০, দক্ষিণ মুগদা", "ঢাকা, বাংলাদেশ"],
  ...
  hero: {
    badge: "মুগদার সেরা স্বাদ",
    backgroundImage:
      "https://images.unsplash.com/photo-1593504049359-74330189a345?q=80&w=2000&auto=format&fit=crop",
    headlineTop: "ক্ষুধা মেটানোর সাধারণ খাবার নয়,",
    headlineBottom: "এক চরম তৃপ্তির বিস্ফোরণ!",
    subheadlinePrefix:
      "সারাদিনের ক্লান্তি শেষে প্রিয়জনদের সাথে এক কামড়েই মন ভালো করার গ্যারান্টি। শুকরানা রেস্টুরেন্ট দিচ্ছে ",
  ...
  blog: {
    ...
    newsletterText:
      "আমাদের নতুন অফার এবং মেনু আপডেট সবার আগে পেতে সাবস্ক্রাইব করুন",
  ...
  contact: {
    ...
    formPlaceholders: {
      ...
      item: "যেমন: চিকেন পিৎজা ২টি",
    },
    infoCards: [
      { title: "ঠিকানা", details: ["৭৯/৮০, দক্ষিণ মুগদা", "ঢাকা, বাংলাদেশ"] },
      {
        title: "ফোন নম্বর",
