            ...
            {filteredItems.map((item, index) => (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  {item.popular && (
                    <span className="absolute top-3 left-3 text-black text-xs font-bold px-2 py-1 rounded-full flex items-center gap-1" style={{ backgroundColor: clientConfig.theme.primary }}>
                      <Flame size={12} />
                      {clientConfig.menu.popularLabel}
                    </span>
                  )}
                </div>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <motion.button
                      ...
                      className="flex items-center gap-1 bg-zinc-800 text-white px-3 py-2 rounded-lg text-sm font-medium transition-all"
                      data-testid={`order-btn-${item.id}`}
                    >
                      <ShoppingBag size={14} />
                      {clientConfig.menu.orderButton}
                    </motion.button>
                  </div>
                </div>
              </motion.div>
